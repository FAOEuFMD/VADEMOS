...
prevpops <- read.csv('newprevpop.csv', sep = ",")
...
predict.pops <- function(df, countrycode, year_to_split, year_to_predict){
...
get.df.with.pop.predicted <<- function(df.c, countrycode, year_to_split, year_to_predict){
  pops_predicted <- predict.pops(df.c, countrycode, year_to_split, year_to_predict) # Predict pops
